				...
				<c:when test="${flag eq 'faq' }">
					<div id="page-inner">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-action">답변달기</div>
									<div class="card-content">
										<form:form action="./ListReplyAction.do" name="writeFrm"
											...
											<table class="table table-bordered">
												...
												<input type="hidden" name="b_flag" value="${flag }" />
												<input type="hidden" name="b_bgroup"
													value="${dto.b_bgroup }" />
												<input type="hidden" name="b_bstep" value="${dto.b_bstep }" />
												<input type="hidden" name="b_bindent"
													value="${dto.b_bindent }" />
												...
												<tr>
													...
													<td><input type="text" class="form-control"
														name="b_title" style="width: 80%" value="${dto.b_title }" /></td>
												</tr>
												<tr>
