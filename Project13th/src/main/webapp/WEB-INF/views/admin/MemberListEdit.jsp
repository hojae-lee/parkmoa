		...
		<div id="page-wrapper">
			...
			<div id="page-inner">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-action">회원수정</div>
							<div class="card-content">
								<form:form action="./ListEditAction.do" name="writeFrm"
									method="post">
									...
									<div class="row text-center" style="padding-left: 10%;">
										...
										<a href="./BoardList.do?boardname=${flag }"><button
